...
from head_tracker import get_head_pose
from eye_tracker import get_eye_direction
from eye_closure import detect_eye_closure
from attention_engine import analyze_attention
from lipsync_detector import detect_mouth_open

logger = logging.getLogger(__name__)

# Worker layout: python_attention_worker/{this file, models/}
WORKER_DIR = Path(__file__).resolve().parent
MODEL_PATH = WORKER_DIR / "models" / "face_landmarker.task"
...
def validate_face_landmarker_asset() -> Path:
    ...
    if not MODEL_PATH.is_file():
        raise FileNotFoundError(
            ...
            "Place face_landmarker.task in python_attention_worker/models/."
        )
    return MODEL_PATH
